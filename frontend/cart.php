...
<?php
								if (!empty($somm) and !empty($date))
						 	 {
								...
								<li class="cart_item clearfix">
									<div class="cart_item_image"><img src="images/esp.jpg" alt=""></div>
									<div class="cart_item_info d-flex flex-md-row flex-column justify-content-between">
										<div class="cart_item_name cart_info_col">
											<div class="cart_item_title">Name</div>
											<div class="cart_item_text"><?php echo $row['id_produit']; ?></div>
										</div>
										...
										<div class="cart_item_price cart_info_col">
											...
											<div class="cart_item_text">125DT</div>
										</div>
										<div class="cart_item_total cart_info_col">

											<form action="supprimerproduit.php" method="post">
										<input  class="button cart_button_clear" type="submit" name="supprimer" value="supprimer">
