...
<body>
            ...
            <div class="animated fadeIn">
                <div class="row">
                                     ...
                                     <?PHP
                                      foreach($list_cmd as $row){
                                        ...
                                        <td>
                                          ...
                                          <input type="submit" name="Modifier" value="Modifier" class="btn btn-info btn-xs"  onclick="getcube()" >
                    ...
                    <div class="col-md-6">
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title"> Listes des Paniers </strong>
                            </div>
                            <div class="card-body">
                                <table id="bootstrap-data-table" class="table table-striped table-bordered">
                                    <thead>
                                     ...
                                     <?PHP
                                      foreach($list_pan as $row){
                                          ...
                                          <td><?PHP echo $row['date_add']; ?></td>
                                           ...
                                           <input type="submit" name="prod" value="voir produit" class="btn btn-warning">
                                            <input type="hidden" value='<?PHP echo $row['id_produit_panier']; ?>' name="id">
                                             </form>
                                              </td>
                                        </tr>
                                        <?PHP
                    ...
                    <?php
                     ...
                     if (isset($_POST['prod'])){
                       ...
                       <div class="col-md-6">
                           <div class="card">
                               <div class="card-header">
                                   <strong class="card-title"> Listes des Produit </strong>
                               </div>
                               <div class="card-body">
    ...
    <script src="vendors/datatables.net/js/jquery.dataTables.min.js"></script> <!-- library for tri , search , organisation -->
